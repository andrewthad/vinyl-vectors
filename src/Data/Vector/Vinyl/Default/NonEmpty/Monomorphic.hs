...
length :: G.Vector VectorVal r => Vector (Rec Identity (r ': rs)) -> Int
length (V (r :& _)) = G.length r
{-# INLINE length #-}

-- | /O(1)/ Test whether a vector if empty
null :: G.Vector VectorVal r => Vector (Rec Identity (r ': rs)) -> Bool
null (V (r :& _)) = G.null r
{-# INLINE null #-}
